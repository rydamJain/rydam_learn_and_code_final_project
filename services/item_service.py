...
class ItemServices:
    ...
    def insert_into_feedback(self, feedback):
        self.db.executemany('''
        INSERT INTO feedback (id, item_id, user_id, rating, comment, date) VALUES (?, ?, ?, ?, ?, ?)
        ''', feedback)
...
#     feedback = [
#     (1, 1, 101, 5, 'Great!', '2023-03-01 10:00:00'),
#     (2, 2, 241, 4, 'Good', '2023-03-01 11:00:00'),
#     (3, 3, 343, 3, 'Okay', '2023-03-01 12:00:00'),
#     (4, 4, 78, 5, 'Awesome', '2023-03-01 12:00:00')
#     ]
...
#     notification = [
#     (1, 1, 101, 'Aloo Paratha is available'),
#     (2, 2, 241, 'Burger is available'),
#     (3, 3, 343, 'Bhindi is available'),
#     (4, 4, 78, 'Paneer is available')
#     ]
#     # Insert records
